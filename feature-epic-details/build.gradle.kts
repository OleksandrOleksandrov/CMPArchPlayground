...
kotlin {
    ...
    androidLibrary {
        namespace = "com.oleksandrov.cmp.arch.playground.earth.polychromatic.imaging.camera.details"
...
//                implementation("io.coil-kt.coil3:coil-network-ktor:3.0.0-alpha08")
                ...
                implementation(project(":data-epic")) // TODO remove when extensions are moved to another module
